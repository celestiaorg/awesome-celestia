...
#### Tools
* [Celestia Endpoints Ninja](https://celestia.endpoints.ninja) - a platform designed to simplify the monitoring and discovery of verified RPC endpoints across the Celestia network. It provides real-time and historical insights into uptime, latency, available interfaces, reachability, and more. With a variety of backend checks and metrics, it ensures you always know which RPCs are performing best.
* [Celestia Collector](https://github.com/f5nodes/celestia-collector) - a robust monitoring tool designed to enhance the performance tracking of all types of Celestia data availability nodes with installation script and public Grafana dashboard: https://celestia.f5nodes.com.
...
- gRPC: `celestia-grpc.f5nodes.com:443`
#### Snapshots
- Mainnet snapshots: https://celestia-snapshots.f5nodes.com
- Testnet snapshots: https://celestia-testnet-snapshots.f5nodes.com
#### Testnet Endpoints
...
- gRPC: `celestia-testnet-grpc.f5nodes.com:443`
